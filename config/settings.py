...
CRONJOBS = [
    ('0 13 * * *', 'mainapp.services.send_mailing_per_day'),
    ('0 13 * * 1', 'mainapp.services.send_mailing_per_week'),
    ('0 13 1 * *', 'mainapp.services.send_mailing_per_month'),
    ('0 13 * * 1-5', 'mainapp.services.send_mailing_per_day_except_weekend')
]
